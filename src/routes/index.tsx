  ...
  return (
    <div className="relative">
      ...
      <div id="entdecken" className="scroll-mt-24">
        <DiscoverRail tone="sun" slug="top-10" title="Top 10 gerade beliebt" subtitle="Was die Community diese Woche feiert." emoji="🔥" emptyMessage="Hier wohnen die 10 beliebtesten Sachen. Aktuell ist es noch ganz still." items={top?.slice(0, 10)} />
        <DiscoverRail tone="plain" slug="perfekt-daheim" title="Perfekt für daheim" subtitle="Prints, Sounds & Templates, die das Zuhause besser machen." emoji="🏡" emptyMessage="Noch hängt nichts an der Wand. Wir suchen Creator, die das ändern." />
        <DiscoverRail tone="mint" slug="frisch" title="Frisch reingekommen" subtitle="Die neuesten Drops aus den Werkstätten." emoji="✨" emptyMessage="Brandneu, sobald die ersten Creator drücken auf 'Veröffentlichen'." items={fresh} />
        <DiscoverRail tone="plain" slug="perlen" title="Versteckte Perlen" subtitle="Untern Radar, aber liebenswert." emoji="💎" emptyMessage="Perlen brauchen erst Austern." />
        <DiscoverRail tone="coral" slug="kuratiert" title="Von der Community kuratiert" subtitle="Handverlesen von Leuten wie dir." emoji="🎀" emptyMessage="Kurator:innen gesucht — die Vitrine ist noch leer." />
      </div>
      <SellerInvite />
      <FaqStickerBoard />
    </div>
